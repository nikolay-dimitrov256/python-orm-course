...
class DirectorAdmin(admin.ModelAdmin):
    ...
    search_help_text = 'Search for directors by their name'
...
class ActorAdmin(admin.ModelAdmin):
    ...
    search_help_text = 'Search for actors by their name'
...
class MovieAdmin(admin.ModelAdmin):
    ...
    search_help_text = 'Search for movies by name and director'
    readonly_fields = ('last_updated',)
