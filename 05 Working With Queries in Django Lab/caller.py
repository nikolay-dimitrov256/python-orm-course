...
def find_authors_nationalities() -> str:
    ...
    result = [f'{str(a)} is {a.nationality}' for a in authors]
...
def filter_authors_by_nationalities(nationality: str) -> str:
    ...
    result = [a.biography if a.biography else str(a) for a in authors]

    return '\n'.join(result)


def filter_authors_by_birth_year(first_year: str, second_year: str) -> str:
