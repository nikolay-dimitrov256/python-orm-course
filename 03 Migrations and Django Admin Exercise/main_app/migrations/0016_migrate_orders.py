# Generated by Django 5.0.4 on 2024-06-29 19:32

from django.db import migrations
from django.utils import timezone


def process_orders(apps, schema_editor):
...
def reverse_orders(apps, schema_editor):
    ...
    order_model.objects.bulk_update(orders, ['warranty', 'delivery'])
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(process_orders, reverse_orders)
    ]
