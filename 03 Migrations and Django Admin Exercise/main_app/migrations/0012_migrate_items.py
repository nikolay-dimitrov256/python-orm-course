# Generated by Django 5.0.4 on 2024-06-29 18:45

from django.db import migrations


def set_rarity(apps, schema_editor) -> None:
...
def delete_rarity(apps, schema_editor) -> None:
    item_model = apps.get_model('main_app', 'Item')
    items = item_model.objects.all()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_rarity, delete_rarity)
    ]
